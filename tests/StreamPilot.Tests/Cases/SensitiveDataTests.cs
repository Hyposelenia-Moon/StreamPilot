...
public sealed class SensitiveDataTests
{
    ...
    {
        string url = "https://cdn.example/live.flv?expires=1700000000&wsSecret=abc123&sign=zzz&quality=4";
